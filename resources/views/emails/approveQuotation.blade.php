...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We're pleased to inform you that your quotation for <strong>{{ $institutionName ?? $name }}</strong> has
                been approved!</p>
            <div class="quotation-details">
                <p><strong>Quotation Reference:</strong> {{ $url }}</p>
                <p><strong>Status:</strong> Approved</p>
            </div>
            <p>You can now proceed with the next steps in your process. The approved quotation is available for viewing
                at any time.</p>
