...
const PackagesSettings: React.FC = () => {
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        const variants = [
            ...
            { room_type: 'quad', board_type: 'Full Board', amount: formData.quad_full_board, key: 'quad_full_board' },
            { room_type: 'quad', board_type: 'Half Board', amount: formData.quad_half_board, key: 'quad_half_board' },
            { room_type: 'quad', board_type: 'Bed & Breakfast', amount: formData.quad_bed_breakfast, key: 'quad_bed_breakfast' },
        ];
    ...
    const handleUpdate = async (e: React.FormEvent) => {
        ...
        const variants = [
            ...
            { room_type: 'quad', board_type: 'Full Board', amount: editFormData.quad_full_board, key: 'quad_full_board' },
            { room_type: 'quad', board_type: 'Half Board', amount: editFormData.quad_half_board, key: 'quad_half_board' },
            { room_type: 'quad', board_type: 'Bed & Breakfast', amount: editFormData.quad_bed_breakfast, key: 'quad_bed_breakfast' },
        ];
