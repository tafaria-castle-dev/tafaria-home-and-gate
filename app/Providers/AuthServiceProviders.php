...
class AuthServiceProviders extends ServiceProvider
{
    protected $policies = [
        ...
        'App\Models\GuestReservation' => 'App\Policies\GuestReservationPolicy',
        'App\Models\PatrolCheckPoint' => 'App\Policies\PatrolCheckPointPolicy',
        'App\Models\CheckPoint' => 'App\Policies\CheckPointPolicy',
